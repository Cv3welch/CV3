...
class Bullet(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if event.type == keystate[pygame.K_TAB]:
...
# I Tried to add projectiles of bullts, and the code seemed to be correct, bit was unsure how to get them to show
g = Game()
# g.show_start_screen()
while g.running:
    g.new()
